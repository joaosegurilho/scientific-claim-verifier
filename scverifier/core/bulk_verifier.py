...
from scverifier.core.benchmarking import METHOD_MAP
...
class BulkVerifier:
    def __init__(
        ...
        claim_column: int = 1,
        id_column: int = 0,
        method: str = "agentless_with_search",
    ):
        ...
        self.method: VerificationMethod = METHOD_MAP.get(method)
    ...
    def run(
        ...
        for i, item in tqdm(enumerate(self.data), disable=not pbar):
